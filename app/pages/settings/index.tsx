        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
          {cards.map((card) => (
            <NuxtLink
              key={card.to}
              to={card.to}
              class="flex items-start gap-4 rounded-2xl bg-card p-6 shadow-sm ring-1 ring-gray-100 transition hover:ring-brand-300 focus:outline-none focus:ring-2 focus:ring-brand-400"
            >
